...
public class TSPlastHoursUltimate extends JFrame{
	...
	for (int i = 0; i < puntillos[Integer.parseInt(theMST.para.get(0))].vecinos.size() ; i++) {
	    ...
	    // The Fringe: 
	    // 0 Path de 0 a 2 con costo 282 
	    // 1 Path de 0 a 3 con costo 387 
	    // 2 Path de 0 a 1 con costo 235 
	    // The MST: 
	    // 0 Path de 0 a 1 con costo 235 
	    quitarRepetidosDelMSTenelFringe(fringe, mst); 
	    quitarRepetidosDelMSTenelFringePATHVERSION(theFringe, theMST); 

	    // COMO EVITAR QUE NO PONGA CAMINOS COMO 'DE 2 A 0'
	    // Contenido fringe :3 , 4 , 3 , 1 , 4 , 
	    // Contenido mst :0 , 2 , 
	    // The Fringe: 
	    // 0 Path de 0 a 3 con costo 242 
	    // 1 Path de 2 a 4 con costo 271 
	    // 2 Path de 2 a 0 con costo 297 
	    // 3 Path de 2 a 3 con costo 236 
	    // 4 Path de 2 a 1 con costo 203 
	    // The MST: 
	    // 0 Path de 0 a 2 con costo 146 
	...
	minor = theFringe.menorDeLosPaths();
	mst.add(theFringe.para.get(minor)); // se mueve el indice si lo haces despues
	theMST.addPath(theFringe.de.get(minor), 
		       theFringe.para.get(minor), 
		       theFringe.pathcost.get(minor)
		       );
	...
	// if not empty	// if not empty	// if not empty	// if not empty	// if not empty	// if not empty
	// if (fringe.size() == 0 || theFringe.para.size() == 0) {  
	//     System.out.printf("esta vaciaaaaaaaaaaa: \n");
	// 	} else {
	//     fringe.remove(theFringe.para.get(minor));
	// }
	// if not empty	// if not empty	// if not empty	// if not empty	// if not empty	// if not empty

	quitarRepetidosDelMSTenelFringe(fringe, mst); 
	quitarRepetidosDelMSTenelFringePATHVERSION(theFringe, theMST);
	// debo de quitar los destinos que ya estan repetidos en el mst del fringe
	...
	// if not empty	// if not empty	// if not empty	// if not empty	// if not empty
	// if (fringe.size() != 0) {fringe.remove(theFringe.para.get(minor));}
	// if (fringe.size() == 0 || theFringe.para.size() == 0) {  
	//     System.out.printf("esta vaciaaaaaaaaaaa: \n");
	// 	} else {
	//     fringe.remove(theFringe.para.get(minor));
	...
	quitarRepetidosDelMSTenelFringePATHVERSION(theFringe, theMST);
	quitarDestinosQueYaEstanEnMSTdeltheFringe(theFringe, mst);
	System.out.printf("33333333333333333333333333333\n");
	System.out.printf("Contenido Unseen :"); imprimirContenidoLista(unseen); 
	System.out.printf("Contenido fringe :"); imprimirContenidoLista(fringe);
	System.out.printf("Contenido mst :");    imprimirContenidoLista(mst);
	System.out.printf("The Fringe :\n");      theFringe.showPaths();
	...
	quitarRepetidosDelMSTenelFringePATHVERSION(theFringe, theMST);
	quitarDestinosQueYaEstanEnMSTdeltheFringe(theFringe, mst);
	System.out.printf("444444444444444444444444444444444\n");
	System.out.printf("Contenido Unseen :"); imprimirContenidoLista(unseen); 
	System.out.printf("Contenido fringe :"); imprimirContenidoLista(fringe);
	System.out.printf("Contenido mst :");    imprimirContenidoLista(mst);
	System.out.printf("The Fringe :\n");      theFringe.showPaths();
	...
	public int menorDeLosPaths(){
	    // SI NO ESTA VACIO
	    int menor = Integer.parseInt(this.pathcost.get(0));;
	    int next = 0;
	    int posMenor = 0;
    ...
    public TSPlastHoursUltimate(){
	setSize(800,600);
	setVisible(true);
    }
    public static void main(String[] args){
	TSPlastHoursUltimate GG = new TSPlastHoursUltimate();
	// GG.repaint();
    }
}
