...
public class TSPestructura extends JFrame{

    // LISTO EL GENERADOR DE PROBLEMAS
    ...
    public void conectarNodosEstructura(// int superconnected[][],
					int de, int a){
	superconnected[de][a] = 1;
	superconnected[a][de] = 1;
    }
	...
	for (int i = 0; i < cuantasVeces; i++) {
	    ...
	    conectarNodosEstructura(dame, dame2);
    ...
    public TSPestructura(){
	setSize(800,600);
	setVisible(true);
    }
    public static void main(String[] args){
	TSPestructura GG = new TSPestructura();
	GG.repaint();
    }
}
