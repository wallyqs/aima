...
public class TSP1 extends JFrame{
	...
	// conectarDosAleatoriosConElUltimo0a9(puntillos, g);
    ...
    public void conectarDosAleatoriosConElUltimo0a9(Punto puntillos[],Graphics g){
	int radioCirculo = 5;
    ...
    // numero aleatorio con el rango del arreglo
