...
public class TSPnewClasses extends JFrame{
    ...
    // public LinkedList<FringeType> theFringe ;
    // public LinkedList<FringeType> theFringe; 
    // public LinkedList<MSTType> theMST; 
	...
	for (int i = 0; i < puntillos[Integer.parseInt(theMST.para.get(0))].vecinos.size() ; i++) {
	    ...
	    // theFringe.addPath(theMST.de.get(0), 
	    // 		      theMST.para.get(0), 
	    // 		      theMST.pathcost.get(0)
	...
	// // meter el 0 al mst path menor 22222222
	// theMST.addPath(theFringe.de.get(minor), 
	// 	       theFringe.para.get(minor), 
	// 	       theFringe.pathcost.get(minor)
	// 	       );
	...
	// // ahora meter los vecinos del que tiene el path menor al fringe 222222
	// for (int i = 0; i < puntillos[minor].vecinos.size() ; i++) {
	//     fringe.add(puntillos[minor].vecinos.get(i));
	//     // AÑADIR LOS COSTOS DE LOS PATHS 22222222222222
	//     theFringe.addPath(minor + "", 
	// 		      puntillos[minor].vecinos.get(i), 
	// 		      puntillos[minor].pesoEnlaces.get(i) 
	// 		      );
	    
	//     unseen.remove(puntillos[minor].vecinos.get(i));
	// }
	// System.out.printf("Contenido Unseen :"); imprimirContenidoLista(unseen); 
	// System.out.printf("Contenido fringe :"); imprimirContenidoLista(fringe);
	// System.out.printf("Contenido mst :");    imprimirContenidoLista(mst);
	...
	// theFringe.showPaths();
	// theFringe.removePath(50, 4, 200);
	// theFringe.showPaths();
	// theFringe.menorDeLosPaths();

	// método para decir cual es el menor de los paths del fringe que es lo importante

	// ... se agrega el path 0 al mst, el nodo 3 al fringe, y el 0 al mst
    }
	...
	public void menorDeLosPaths(){
	    ...
	    System.out.printf("El menor de los paths es de %s a %s con costo %s \n", de.get(posMenor), para.get(posMenor), pathcost.get(posMenor));
	}
    ...
    public TSPnewClasses(){
	setSize(800,600);
	setVisible(true);
    }
    public static void main(String[] args){
	TSPnewClasses GG = new TSPnewClasses();
	// GG.repaint();
    }
}
